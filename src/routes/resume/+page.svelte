...
<div class="container mx-auto bg-white shadow-2xl rounded-3xl min-h-screen">
    <div class=" mx-auto prose prose-resume max-w-none p-4">
        ...
        <h2 class="grid grid-cols-2">
            <span>Ottawa, ON</span>
            <a
                class="font-bold text-resume relative"
                href="https://www.seofernando.com"
            >
                www.seofernando.com
                <div
                    class="absolute bottom-8 left-60 right-0 rotate-[25deg] text-sm text-resume"
                >
                    Check out my personal projects!
                </div>
            </a>
            <span>(609) 401-9906</span>
            <span>abert036@uottawa.ca</span>
        </h2>
        ...
        <main class="flex flex-col gap-4">
            ...
            <section class="rounded-xl card-compact outline">
                <div class="card-body">
                    ...
                    <p>
                        Undergraduate student at the <strong
                            >University of Ottawa</strong
                        >, pursuing an
                        <strong>
                            Honours Bachelor of Science with Major in Computer
                            Science and Minor in Statistics (French Immersion
                            Stream)
                        </strong>
                        with an expected graduation date by the summer of
                        <strong>2025</strong>. <br /> Self-taught and driven by passion
                        for technology. Focused on a mindset of continuous improvement.
                        I am a strong believer of the adoption of faster, cleaner
            ...
            <section class="rounded-xl card-compact outline">
                <div class="card-body">
                    ...
                    <ul class="m-0">
                        <li>
                            Ported an existing <strong
                                >NodeJS microservice</strong
                            >
                            to use
                        ...
                        <li>
                            Aided in the clean-up of a legacy codebase including
                            the removal of over 4000 linting issues
                        </li>
                        <li>
                            Contributed over
                            <span class="resume-primary">+23,000 additions</span
                            >
                            and
                    ...
                    <ul class="m-0">
                        <li>
                            Simplified build process of projects from using git
                            submodules to
                            <strong>Conan</strong>.
                        </li>
                        <li>
                            General maintenance of a <strong>Rust</strong
                            >/<strong>C</strong> codebase including fixing memory
                            leaks and improving code maintainability.
                        </li>
                        <li>
                            Facilitated and standardized the development
                            environment of new team members with <strong
                                >Dev Containers</strong
                            >
                        </li>
                        <li>
                            Ported a legacy Java based ground station code-base
                            to a modern web-based one using
                            <strong>SvelteKit</strong>,
                            <strong>Postgres</strong> and
                            <strong>Hasura</strong> improving DX and UX for the Ground
                            Crew.
                        </li>
                    </ul>
                    <!-- 3 -->
                    ...
                    <h5>Odin Team · Trading Central</h5>
                    <ul class="m-0">
                        <li>
                            Contributed to the development of a trading analysis
                            tool called
                            <a
                                class="text-resume"
                                href="https://www.tradingcentral.com/tc-products/tc-options-insight"
                                >Options Insight</a
                            >
                        </li>
                        <li>
                            Ported legacy <strong>Jenkins</strong> pipelines to use
                            newer versions of NodeJS
                        </li>
                        <li>
                            Introduced my team to <strong
                                >End-to-End Testing</strong
                            >
                            using <strong>Playwright</strong>
                        </li>
                        <li>
                            Wrote <strong> automation scripts</strong> for development
                            environment setup and projects initialization.
                        </li>
                        <li>
                            Introduced my team to
                            <strong> git commit hooks </strong>
                            to better enforce code quality, formatting and linting.
                        </li>
                        <li>
                        ...
                        <li>
                            Contributed over
                            <span class="resume-primary">+80,000 additions</span
                            >
                            and
                            <span class="text-error">-100,000 deletions</span>
                            of peer reviewed code in a 4 month period.
                        </li>
                    </ul>
                </div>
